...
public class DriveQuickstart {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        Credential credential = new AuthorizationCodeInstalledApp(flow, receiver).authorize("738906612893-q8ugepcr65n061ggvq9k44hg0i6hb34q.apps.googleusercontent.com");
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        if (files == null || files.isEmpty()) {
            ...
            FileList resultImagenes = service.files().list()
                    .setQ("name contains 'Pou_tactico' and parents in '"+dirImagenes+"'")
                    .setSpaces("drive")
                    .setFields("nextPageToken, files(id, name)")
                    .execute();
            ...
            for (File file : filesImagenes) {
                ...
                OutputStream outputStream = new FileOutputStream("C:\\Users\\alex0\\your_aux.jpeg");
